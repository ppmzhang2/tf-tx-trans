...
def make_batch(
    ...
    return ds.shuffle(BUFFER_SIZE).map(
        _encoder,
...
def load_train_valid(
    ...
    return (
        make_batch(ds_tr, pt_tkr, en_tkr, integer),
        make_batch(ds_va, pt_tkr, en_tkr, integer),
        info,
    )


if __name__ == "__main__":
    train_data, val_data, _ = load_train_valid(integer=True)
